...
function App(props) {
    ...
    return (
        <SnackbarProvider>
            <Box
                sx={{ display: "flex", flexDirection: "column", flexFlow: "column", height: screenSize.dynamicHeight }}
            >
                <NavBar
                    username={username}
                    password={password}
                    ...
                    <Router>
                        <Routes>
                            ...
                            <Route
                                path="/editor"
                                element={
                                    <Editor username={username} room={room} setIsDisconnected={setIsDisconnected} />
                                }
                            />
                        </Routes>
                    </Router>
